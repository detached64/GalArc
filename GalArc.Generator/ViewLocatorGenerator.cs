...
[Generator]
internal sealed class ViewLocatorGenerator : IIncrementalGenerator
{
    ...
    private static string GenerateSource(ImmutableArray<string> classNames)
    {
        ...
        {
            if (!className.Contains("ViewModels"))
                sb.AppendLine($"                {className} => new {className.Replace("Options", "Widget")}(),");
        }
        ...
        {
            if (className.Contains("ViewModels"))
                sb.AppendLine($"                {className} => new {className.Replace("ViewModels", "Views").Replace("Options", "Widget")}(),");
        }
        sb.AppendLine("                _ => new TextBlock { Text = \"Not Found: \" + param?.GetType().FullName }");
        sb.AppendLine("            };");
        sb.AppendLine("        }");
