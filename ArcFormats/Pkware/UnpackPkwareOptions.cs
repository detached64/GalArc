...
{
    public partial class UnpackPkwareOptions : OptionsTemplate
    {
        public static UnpackPkwareOptions Instance { get; } = new UnpackPkwareOptions();

        public PkwareOptions Options = new PkwareOptions();

        public PkwareScheme Scheme;

        public UnpackPkwareOptions()
        {
            InitializeComponent();
        }
