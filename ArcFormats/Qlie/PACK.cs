...
namespace ArcFormats.Qlie
{
    public class PACK : ArchiveFormat
    {
        ...
        internal class QlieHash1_4          // length: QlieKey.HashSize
        {
        ...
        internal class QlieHash1_3          // length: QlieKey.HashSize
        {
            public uint Const { get; set; }         // 0x100
            public int FileCount { get; set; }
        ...
        private const string HeaderMagic3_0 = "FilePackVer3.0";
        private const string HeaderMagic2_0 = "FilePackVer2.0";
        private const string HeaderMagic1_0 = "FilePackVer1.0";
    }
}
